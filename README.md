...
- <ins>You ***NEED*** to generate your own SMBIOS info using</ins> [GenSMBIOS](https://github.com/corpnewt/GenSMBIOS) <ins> with `MacBookPro10,1` and place it in your config.plist before being able to use this EFI.</ins> If you don't know how to do this, see: **"What if I don't know how to use GenSMBIOS?"**
