...
**<ins>Only use this EFI if you know what you're doing and can edit the config.plist according to your own hardware and needs.</ins>**
...
## Considerations
   ...
   ### config.plist
   - Make sure to generate your own SMBIOS information with [GenSMBIOS](https://github.com/corpnewt/GenSMBIOS) using `MacBookPro10,1` and place it in `PlatformInfo` before using this EFI. If you don't know how to do this, see: **"What if I don't know how to use [GenSMBIOS](https://github.com/corpnewt/GenSMBIOS)?"**
